        ...
        <div class="comments">
            <div class="comment-items-wrap">
                <div v-for="item in comments.data" class="comment-item">
                    <a hreflang="javascript:;" class="comment-author-avatar-link">
            ...
            <div v-if="comments.hasNext" class="load-more-wrap">
                <a @click="loadMore()" href="javsscript:;" class="comments-load-more">加载更多</a>
            </div>
        </div>
    </div>
</template>
...
<script lang="babel">
    ...
    export default {
        ...
        computed: {
            ...mapGetters({
                comments: 'global/comments/getCommentList'
            })
        },
        methods: {
